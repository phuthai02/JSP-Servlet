...
<div class="row">
	...
	<div class="col-xl-6">
		<div class="fs-4 h-100">
			...
			<div class="fs-1 fw-bold text-center">Add product</div>
			<hr>
			<form action="/Assignment/products/store" class=" align-self-center"
				method="post" enctype="multipart/form-data">
				<div>
					<label class="fw-bold">Product's Name</label> <input name="name"
						type="text" name="name" class="form-control fs-5" required="required"
						autocomplete="off">
				</div>
				<div class="mt-2">
				...
				<div class="mt-2">
					<label class="fw-bold">Images</label> <input name="img" type="file" required="required"
						class="form-control fs-5">
				</div>
				<hr>
				<div class="mt-2">
					<button class="btn btn-primary fs-4">Add now</button>
